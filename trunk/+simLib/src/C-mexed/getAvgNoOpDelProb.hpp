...
template<class Encoder, class Decoder> struct _simRes simMex(bool isSystematic, unsigned int kl, double pl, double per, unsigned int hatTaul, unsigned int iterations, unsigned int seed, bool pruneZeros);
