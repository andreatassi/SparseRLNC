...
struct simRes {
    double interceptProb;
    double decProb;
};

template<class Encoder, class Decoder, class Decoder_an> struct simRes simMex(unsigned int K, unsigned int N, double * p, bool isSystematic, bool pruneZeros,
...
typedef kodo::rlnc::full_vector_decoder_count<fifi::binary> Decoder1_an;
...
typedef kodo::rlnc::full_vector_decoder_count<fifi::binary4> Decoder4_an;
...
typedef kodo::rlnc::full_vector_decoder_count<fifi::binary8> Decoder8_an;
...
typedef kodo::rlnc::full_vector_decoder_count<fifi::binary16> Decoder16_an;
