function [ ] = getFig23( inSim1, inSim2, inSim3, inTh1, inTh2, inTh3, inIA1, inIA2, inIA3, Xlim, Ylim, Xtick, Ytick, Off, hasLegend, filename, isLB )
    Y = ones(500,6);
    ...
    MRK = {'square','+', 'v','o'};
    aa = plot([10 10], [10 10]);
    set(aa(1),'Color',CL(4,:), 'MarkerSize',10,'Marker','none','LineStyle', '-','LineWidth',1.5); % Sim
    aa = plot([10 10], [10 10]);
    ...
    if hasLegend
        LG = legend(AX,'$K = 10$', '$K = 20$', '$K = 50$','$\quad$Simulations', ...
    ...
    if hasLegend
        set(LG,'position',[0.572822807482786 0.135833062065972 0.409856446584066 0.486111111111111]);
    end
